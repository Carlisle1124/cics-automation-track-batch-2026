			...
			<Modal isOpen={isModalOpen} title="Reserve a Slot" onClose={handleClose}>
				...
				{phase === 'confirmed' && confirmedReservation && (
					<div className="reserve-success">
						...
						<div className="reserve-modal-form__actions reserve-modal-form__actions--success">
				...
				{phase === 'form' && (
					<form className="reserve-modal-form" onSubmit={handleHoldSubmit}>
						<div className="booking-rules">
							<div className="booking-rules__header">
								<h3 className="booking-rules__title">
									Booking Rules
								</h3>
							</div>
							<div className="booking-rules__grid">
								{[
									...
									<div key={label}>
										<span className="booking-rules__item-label">
											{label}
										</span>
										<span className="booking-rules__item-value">
											{value}
										</span>
									</div>
								))}
